...
def int_comp(a):
    ...
    if a==0:
        ...
        return '京アニ'
def generate(args, g_ema, device, mean_latent,one_hot,comp):

    with torch.no_grad():
        g_ema.eval()
        for i in tqdm(range(args.pics)):
            sample_z = torch.randn(args.sample, 512, device=device)
...
if __name__ == "__main__":
    ...
    for i in range(9):
        ...
        generate(args, g_ema, device, mean_latent,one_hot,i)

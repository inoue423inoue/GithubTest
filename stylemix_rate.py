...
def generate(args, g_ema, device, mean_latent):
    ...
    with torch.no_grad():
        ...
        utils.save_image(
                sample_image1,
                f"output_stylemix_rate/base.png",
                nrow=1,
                normalize=True,
                range=(-1, 1),
            )
        ...
        utils.save_image(
                ...
                f"output_stylemix_rate/effect.png",
                nrow=1,
                normalize=True,
                range=(-1, 1),
            )
        ...
        for i in tqdm(range(11)):
            ...
            for k in range(12):
                ...
                for j in range(12):
                    if k==j:
                        l = l+[latent2[0][j].unsqueeze(0).unsqueeze(0).to('cuda:0')*rate]
                    else:
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_rate/{str(rate)}_1_w{str(k)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )
            ...
            for k in range(0,12,2):
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_rate/{str(rate)}_2_w{str(k)}_{str(k+1)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )
            ...
            for k in range(0,12,4):
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_rate/{str(rate)}_4_w{str(k)}_{str(k+3)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )

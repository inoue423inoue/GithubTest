...
def generate(args, g_ema, device, mean_latent):
    ...
    with torch.no_grad():
        ...
        for i in tqdm(range(args.pics)):
            utils.save_image(
                sample_image1,
                f"output_stylemix_solo/{str(i).zfill(3)}_0_base.png",
                nrow=1,
                normalize=True,
                range=(-1, 1),
            )
            ...
            utils.save_image(
                ...
                f"output_stylemix_solo/{str(i).zfill(3)}_0_effect.png",
                nrow=1,
                normalize=True,
                range=(-1, 1),
            )
            ...
            for k in range(12):
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_solo/{str(i).zfill(2)}_1_w{str(k)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )
            ...
            for k in range(0,12,2):
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_solo/{str(i).zfill(2)}_2_w{str(k)}_{str(k+1)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )
            ...
            for k in range(0,12,4):
                ...
                utils.save_image(
                    sample_imagex,
                    #f"output_stylemix/{str(i).zfill(6)}.png",
                    f"output_stylemix_solo/{str(i).zfill(2)}_4_w{str(k)}_{str(k+3)}.png",
                    nrow=1,
                    normalize=True,
                    range=(-1, 1),
                )
